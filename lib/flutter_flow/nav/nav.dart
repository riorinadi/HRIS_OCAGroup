...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Office',
          path: '/office',
          builder: (context, params) => OfficeWidget(),
        ),
        FFRoute(
          name: 'ChooseOffice',
          path: '/chooseOffice',
          builder: (context, params) => ChooseOfficeWidget(),
        ),
        FFRoute(
          name: 'HistoryAttendance',
          path: '/historyAttendance',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'HistoryAttendance')
              : HistoryAttendanceWidget(),
        ),
        FFRoute(
          name: 'ReportAttendance',
          path: '/reportAttendance',
          builder: (context, params) => ReportAttendanceWidget(),
        ),
        FFRoute(
          name: 'Leave',
          path: '/leave',
